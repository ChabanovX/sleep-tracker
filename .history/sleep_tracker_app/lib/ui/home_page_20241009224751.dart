              ...
              Expanded(
                child: Column(
                  children: [
                    ...
                    const Expanded(child: SizedBox()), // Space at the bottom
                  ],
                ),
              ),
            ],
...
/*************  ✨ Codeium Command ⭐  *************/
  /// Returns a card widget that contains a centered text and a checkmark
  /// below it. The card is designed to be used in a horizontal list and
/******  0637697b-49a4-4a1f-82c7-8408d892394a  *******/
